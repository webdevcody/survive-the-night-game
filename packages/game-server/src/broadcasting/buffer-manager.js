...
import { GAME_STATE_BIT_TIMESTAMP, GAME_STATE_BIT_PHASE_START_TIME, GAME_STATE_BIT_PHASE_DURATION, GAME_STATE_BIT_IS_FULL_STATE, GAME_STATE_BIT_REMOVED_ENTITY_IDS, GAME_STATE_BIT_MAP_DATA, GAME_STATE_BIT_VOTING_STATE, GAME_STATE_BIT_ZOMBIE_LIVES_STATE, GAME_STATE_FIELD_BITS, } from "@shared/util/serialization-constants";
/**
...
export class BufferManager {
     ...
     */
    writeEntity(entity, onlyDirty = false) {
     ...
     */
    writeGameState(gameState, hasRemovedEntities = false, mapData, votingState, zombieLivesState) {
     ...
     */
    writeZombieLivesState(zombieLivesState) {
     ...
     */
    writeRemovedEntityIds(removedIds) {
