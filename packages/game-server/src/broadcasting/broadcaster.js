...
export class Broadcaster {
    ...
    printStats() {
        ...
        const mbPerSecond = elapsedSeconds > 0 ? this.bytesSentThisSecond / (1024 * 1024) / elapsedSeconds : 0;
        console.log(`[Bandwidth] ${mbPerSecond.toFixed(5)} MB/s (${this.deps.io.sockets.sockets.size} players)`);
    }
    /**
     ...
     */
    broadcastGameStateUpdate(event) {
        var _a, _b, _c, _d, _e, _f;
        // Track entity state tracking operations
        const endEntityStateTracking = ((_a = this.deps.tickPerformanceTracker) === null || _a === void 0 ? void 0 : _a.startMethod("entityStateTracking", "broadcastGameState")) ||
            (() => { });
        ...
        const eventSerialize = event.serialize;
        ...
        const endGameStatePrep = ((_b = this.deps.tickPerformanceTracker) === null || _b === void 0 ? void 0 : _b.startMethod("gameStatePreparation", "broadcastGameState")) ||
            (() => { });
        ...
        const endEntitySerialization = ((_c = this.deps.tickPerformanceTracker) === null || _c === void 0 ? void 0 : _c.startMethod("entitySerialization", "broadcastGameState")) ||
            (() => { });
        // Write entity count
        ...
        const endGameStateMerging = ((_d = this.deps.tickPerformanceTracker) === null || _d === void 0 ? void 0 : _d.startMethod("gameStateMerging", "broadcastGameState")) ||
            (() => { });
        ...
        const mergedGameState = Object.assign({}, changedGameState);
        for (const key in eventData) {
        ...
        this.deps.bufferManager.writeGameState(Object.assign(Object.assign({}, mergedGameState), { timestamp, isFullState: false }), hasRemovedEntities, undefined, // no mapData for delta updates
        votingState, zombieLivesState);
        ...
        const endCleanup = ((_e = this.deps.tickPerformanceTracker) === null || _e === void 0 ? void 0 : _e.startMethod("broadcastCleanup", "broadcastGameState")) ||
            (() => { });
        ...
        if (this.deps.tickPerformanceTracker && changedCount > 0) {
            ...
            if (dirtyEntityInfo.length > 0) {
                this.deps.tickPerformanceTracker.recordDirtyEntities(dirtyEntityInfo.map((info) => ({
                    id: String(info.id),
                    type: info.type,
                    reason: info.reason,
        ...
        const endWebSocketEmit = ((_f = this.deps.tickPerformanceTracker) === null || _f === void 0 ? void 0 : _f.startMethod("webSocketEmit", "broadcastGameState")) ||
            (() => { });
