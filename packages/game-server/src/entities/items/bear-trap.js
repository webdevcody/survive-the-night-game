 ...
 */
export class BearTrap extends Entity {
    static get SIZE() {
    ...
    constructor(gameManagers, itemState) {
        ...
        this.serialized = new SerializableFields({ isArmed: true, snaredEntityId: null }, () => this.markEntityDirty());
        const count = (_a = itemState === null || itemState === void 0 ? void 0 : itemState.count) !== null && _a !== void 0 ? _a : BearTrap.DEFAULT_COUNT;
        ...
        this.addExtension(new Carryable(this, "bear_trap").setItemState({ count }));
    ...
    snare() {
        ...
        const nearbyEntities = this.getEntityManager().getNearbyEntities(position, BearTrap.TRIGGER_RADIUS, targetTypesSet);
        ...
        for (const entity of nearbyEntities) {
            if (!entity.hasExt(Positionable) || !entity.hasExt(Movable))
                continue;
            // Skip the owner
...
BearTrap.TRIGGER_RADIUS = getConfig().combat.ITEM_TRIGGER_RADIUS;
BearTrap.DEFAULT_COUNT = 1;
