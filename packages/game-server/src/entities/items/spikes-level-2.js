...
export class SpikesLevel2 extends Entity {
    ...
    constructor(gameManagers, itemState) {
        ...
        const count = (_a = itemState === null || itemState === void 0 ? void 0 : itemState.count) !== null && _a !== void 0 ? _a : SpikesLevel2.DEFAULT_COUNT;
        ...
        this.addExtension(new Interactive(this).onInteract(this.interact.bind(this)).setDisplayName("reinforced spikes"));
        this.addExtension(new Carryable(this, "spikes_level_2").setItemState({ count }));
        this.addExtension(new Placeable(this));
    }
    interact(entityId) {
        const carryable = this.getExt(Carryable);
        carryable.pickup(entityId, Carryable.createStackablePickupOptions(carryable, SpikesLevel2.DEFAULT_COUNT));
    }
}
SpikesLevel2.DEFAULT_COUNT = 1;
