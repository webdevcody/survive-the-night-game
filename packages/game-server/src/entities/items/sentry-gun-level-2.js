...
export class SentryGunLevel2 extends Entity {
    ...
    constructor(gameManagers, itemState) {
        ...
        const count = (_a = itemState === null || itemState === void 0 ? void 0 : itemState.count) !== null && _a !== void 0 ? _a : SentryGunLevel2.DEFAULT_COUNT;
        const poolManager = PoolManager.getInstance();
        const size = poolManager.vector2.claim(16, 16);
        this.addExtension(new Positionable(this).setSize(size));
        this.addExtension(new Collidable(this).setSize(size));
        this.addExtension(new Interactive(this).onInteract(this.interact.bind(this)).setDisplayName("improved sentry gun"));
        this.addExtension(new Destructible(this)
            .setMaxHealth(getConfig().world.SENTRY_GUN_LEVEL_2_MAX_HEALTH)
            .setHealth((_b = itemState === null || itemState === void 0 ? void 0 : itemState.health) !== null && _b !== void 0 ? _b : getConfig().world.SENTRY_GUN_LEVEL_2_MAX_HEALTH)
            .onDeath(() => this.onDeath()));
        this.addExtension(new Carryable(this, "sentry_gun_level_2").setItemState({
            count,
        }));
    ...
    interact(entityId) {
        ...
        const stackableOptions = Carryable.createStackablePickupOptions(carryable, SentryGunLevel2.DEFAULT_COUNT);
        ...
        stackableOptions.mergeStrategy = (existing, pickup) => {
            ...
            return Object.assign(Object.assign({}, merged), { health: (_a = pickup === null || pickup === void 0 ? void 0 : pickup.health) !== null && _a !== void 0 ? _a : getConfig().world.SENTRY_GUN_LEVEL_2_MAX_HEALTH });
        };
...
SentryGunLevel2.DEFAULT_COUNT = 1;
