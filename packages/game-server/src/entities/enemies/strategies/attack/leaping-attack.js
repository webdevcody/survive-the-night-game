...
export class LeapingAttackStrategy {
    constructor(leapingState, leapConfig) {
        this.leapDuration = 0;
    ...
    update(zombie, deltaTime) {
        ...
        if (!this.leapingState.isLeaping &&
            ...
            zombie
                .getExt(Movable)
                .setVelocity(poolManager.vector2.claim(leapVelocity.x * this.leapConfig.leapSpeed, leapVelocity.y * this.leapConfig.leapSpeed));
