...
(function (ChargingState) {
    ChargingState[ChargingState["WALKING"] = 0] = "WALKING";
    ChargingState[ChargingState["CHARGING"] = 1] = "CHARGING";
    ChargingState[ChargingState["SLAMMING"] = 2] = "SLAMMING";
    ChargingState[ChargingState["RECOVERING"] = 3] = "RECOVERING";
...
export class ChargingTyrant extends BossEnemy {
    constructor(gameManagers) {
        ...
        this.walkingMovementStrategy = new MeleeMovementStrategy();
        ...
        this.chargingMovementStrategy = new ChargingMovementStrategy(this.chargeConfig.chargeSpeedMultiplier);
        this.groundSlamStrategy = new GroundSlamAttackStrategy(this.chargeConfig.slamRadius, this.chargeConfig.slamDamage, this.chargeConfig.knockbackForce);
