 ...
 */
export class RetreatStateHandler {
    handle(input, playerPos, context) {
        ...
        if (!hasBandage) {
            ...
            if (bandageTarget && bandageTarget.distance && bandageTarget.distance < AI_CONFIG.RETREAT_PICKUP_RADIUS) {
                if (bandageTarget.distance <= AI_CONFIG.INTERACT_RADIUS &&
                    ...
                    const result = AIInteractionHelper.tryPickupItem(context.player, bandageTarget.entity, context.targetingSystem, "RETREAT");
                    if (result.success) {
                    ...
                    if (!context.currentTarget ||
                        ...
                        ((_a = context.currentTarget.entity) === null || _a === void 0 ? void 0 : _a.getId()) !== ((_b = bandageTarget.entity) === null || _b === void 0 ? void 0 : _b.getId())) {
        ...
        if (!movedToWaypoint) {
            ...
            context.recalculatePath();
            if (!context.currentWaypoint) {
                const safestDir = (_c = context.enhancedThreatInfo) === null || _c === void 0 ? void 0 : _c.safestRetreatDirection;
                if (safestDir) {
                    const retreatTarget = new Vector2(playerPos.x + safestDir.x * 300, playerPos.y + safestDir.y * 300);
     ...
     */
    findRandomWalkableDirection(input, playerPos, context) {
