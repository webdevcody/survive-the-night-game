...
import { getEffectiveShootingRange, getMeleeAttackRange, getMeleeRangeWithBuffer, calculateRetreatPosition, aimAtTarget, aimAtTargetWithInaccuracy, } from "../ai-utils";
/**
 * ENGAGE state handler - combat with any enemy (zombie or player)
 */
export class EngageStateHandler {
    handle(input, playerPos, context) {
        ...
        if (!combatTarget || !combatTarget.entity) {
            ...
            if (context.currentWaypoint) {
                ...
                if (!context.currentTarget) {
                    ...
                    context.setCurrentTarget(context.targetingSystem.getExploreTarget(context.player, exploredCells));
                }
                if (context.currentTarget) {
        ...
        const shouldKiteRetreat = lastDecision && lastDecision.decision === AIDecision.RETREAT_AND_FIGHT;
     ...
     */
    handleRangedCombat(input, playerPos, enemyPos, dist, context) {
     ...
     */
    handleMeleeCombat(input, playerPos, enemyPos, dist, context) {
     ...
     */
    handleEscapeBehavior(input, playerPos, enemyPos, context) {
        var _a;
        ...
        const safestDir = (_a = context.enhancedThreatInfo) === null || _a === void 0 ? void 0 : _a.safestRetreatDirection;
        let escapeTarget;
        if (safestDir) {
     ...
     */
    handleDisengageBehavior(input, playerPos, enemyPos, dist, context) {
        var _a, _b;
        if (dist <= AI_CONFIG.IMMEDIATE_THREAT_RADIUS ||
            ((_a = context.enhancedThreatInfo) === null || _a === void 0 ? void 0 : _a.hasImmediateThreat)) {
        ...
        const safestDir = (_b = context.enhancedThreatInfo) === null || _b === void 0 ? void 0 : _b.safestRetreatDirection;
        let disengageTarget;
        if (safestDir) {
     ...
     */
    handleKitingRetreat(input, playerPos, enemyPos, dist, context) {
        var _a;
        const retreatDir = (_a = context.enhancedThreatInfo) === null || _a === void 0 ? void 0 : _a.safestRetreatDirection;
        let retreatTarget;
        if (retreatDir) {
