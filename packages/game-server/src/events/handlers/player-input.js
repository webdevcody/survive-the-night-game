...
function validateInput(input) {
    ...
    return {
        ...
        fire,
        sprint,
        aimAngle: aimAngle !== undefined ? aimAngle : undefined,
        aimDistance: aimDistance !== undefined ? Math.min(1000, aimDistance) : undefined, // Clamp to max 1000
    };
}
...
export const playerInputHandler = {
    event: "PLAYER_INPUT",
