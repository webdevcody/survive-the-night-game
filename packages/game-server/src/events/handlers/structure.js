 ...
 */
function validatePlaceStructureData(data) {
 ...
 */
function getUpgradeTarget(placingItemType, existingEntityType) {
    const itemConfig = itemRegistry.get(placingItemType);
    if (!(itemConfig === null || itemConfig === void 0 ? void 0 : itemConfig.upgradeTo)) {
        return null;
    }
 ...
 */
function findUpgradeableEntity(context, placePos, placingItemType, structureSize) {
...
export function onPlaceStructure(context, socket, data) {
    var _a, _b;
    const player = context.players.get(socket.id);
    if (!player)
        return;
    const itemConfig = itemRegistry.get(data.itemType);
    if (!(itemConfig === null || itemConfig === void 0 ? void 0 : itemConfig.placeable)) {
        return;
    }
    ...
    const itemIndex = inventoryItems.findIndex((item) => (item === null || item === void 0 ? void 0 : item.itemType) === data.itemType);
    if (itemIndex === -1) {
        return;
    }
    ...
    if (upgradeableEntity) {
        ...
        if (((_a = item === null || item === void 0 ? void 0 : item.state) === null || _a === void 0 ? void 0 : _a.count) && item.state.count > 1) {
            inventory.updateItemState(itemIndex, Object.assign(Object.assign({}, item.state), { count: item.state.count - 1 }));
        }
        else {
        ...
        if (upgradeItemConfig === null || upgradeItemConfig === void 0 ? void 0 : upgradeItemConfig.placeSound) {
            context.broadcastEvent(new BuildEvent({
    ...
    // Remove item from inventory
    const item = inventoryItems[itemIndex];
    if (((_b = item === null || item === void 0 ? void 0 : item.state) === null || _b === void 0 ? void 0 : _b.count) && item.state.count > 1) {
...
export const placeStructureHandler = {
