 ...
 */
function validateConsumeItemData(data) {
...
export function onConsumeItem(context, socket, data) {
    ...
    if (data.itemType !== null) {
        ...
        const foundIndex = inventoryItems.findIndex((invItem) => (invItem === null || invItem === void 0 ? void 0 : invItem.itemType) === data.itemType);
        if (foundIndex !== -1) {
...
export const consumeItemHandler = {
    event: "CONSUME_ITEM",
