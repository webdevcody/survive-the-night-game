...
export class ArrowClient extends ClientEntityBase implements IClientEntity, Renderable {
  ...
  public render(ctx: CanvasRenderingContext2D, gameState: GameState): void {
    ...
    // Draw brown/tan arrow (different from yellow bullet)
    ctx.beginPath();
    ...
    if (this.hasExt(ClientCollidable)) {
      debugDrawHitbox(ctx, this.getExt(ClientCollidable).getHitBox(), "brown");
    }
  }
}
